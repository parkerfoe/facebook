...
**From the scatterplot and the linear regression model, there is no significant correlation between age of politician and percentage of negative comments received. Therefore, we can say that there are not more negative comments on the pages of younger politicians.**
